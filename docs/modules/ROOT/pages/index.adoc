...
For the current limitations of the connector, see xref:known-issues.adoc[].

All 6.x versions of the connector require Scala 2.13.

The minimum required version of the Java runtime is 17.
