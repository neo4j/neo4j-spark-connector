...
----
$SPARK_HOME/bin/spark-shell --packages org.neo4j.connectors:spark:{exact-connector-version}-s_{scala-version}
----
=====
...
[source, shell, subs="attributes+"]
----
$SPARK_HOME/bin/pyspark --packages org.neo4j.connectors:spark:{exact-connector-version}-s_{scala-version}
----
=====
====
...
[source, shell, subs="attributes+"]
----
scala spDependencies += "org.neo4j.connectors/spark:{exact-connector-version}-s_{scala-version}"
----
=====
...
dependencies {
    ...
    compile "org.neo4j.connectors:spark:{exact-connector-version}-s_{scala-version}"
}
----
