...
* Advanced use cases might call for xref:performance/cypher-tuning.adoc[Cypher Query tuning]. label:new[New in 6.0]
** Specify versons `CYPHER 5` or `CYPHER 25`
** E.g. enable parallel runtimes for reads
** Full flexibility to tune any existing Cypher preamble parameter
