...
* label:new[New in 6.0] Advanced use cases might need advanced xref:performance/cypher-tuning.adoc[query tuning], including:
** Specifying the Cypher version as `CYPHER 25` or `CYPHER 5`.
** Enabling parallel runtimes for reads.
** Tuning any existing Cypher preamble parameters.
