...
When the connector fetches data from Neo4j during read operations we offer the possibility to partition the query in smaller chunks to parallelize the workload.
