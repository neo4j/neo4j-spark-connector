...
For example, if you want to write a long list of `:Person` nodes which are distinct by the person `id`, you can stream those into Neo4j in four different partitions and avoid any lock contention.
