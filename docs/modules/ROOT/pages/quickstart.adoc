...
$SPARK_HOME/bin/spark-submit \
  --packages org.neo4j.connectors:spark:{exact-connector-version}-s_{scala-version} \
  --class SparkApp \
...
The code repository includes two https://github.com/neo4j/neo4j-spark-connector/tree/6.0/examples[Jupyter notebooks] that show how to use the connector in a data-driven workflow:
